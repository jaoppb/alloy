...
We as members, contributors, and leaders pledge to make participation in the Alloy community a harassment-free
...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions, and any other official
Alloy communication channel), and also applies when an individual is officially representing the community in public
spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers by
[opening an issue](https://github.com/jaoppb/alloy/issues/new) marked as confidential, or by contacting
[@jaoppb](https://github.com/jaoppb) directly through GitHub. All complaints will be reviewed and investigated promptly
and fairly.
...
specified period of time, including unsolicited interaction with those enforcing the Code of Conduct. Violating these
